...
cd /root/MEGA-MD && pm2 start dist/index.js --name ꧁Juniaswrld꧂
...
tmux new -s ꧁Juniaswrld꧂    # Start new session
npm start

# Detach:     Ctrl+B → D
# Re-attach:  tmux attach -t ꧁Juniaswrld꧂
# List:       tmux ls
# Kill:       tmux kill-session -t ꧁Juniaswrld꧂
```
...
# Keep alive with PM2
npm install -g pm2
pm2 start dist/index.js --name ꧁Juniaswrld꧂
pm2 save && pm2 startup
```
...
| Command | Description |
|---|---|
| `pm2 logs ꧁Juniaswrld꧂` | Live logs |
| `pm2 restart ꧁Juniaswrld꧂` | Restart |
| `pm2 stop ꧁Juniaswrld꧂` | Stop |
...
[![WhatsApp](https://img.shields.io/badge/WhatsApp_Channel-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://whatsapp.com/channel/0029VbCSAX4AO7RHo5Ygk00h)
